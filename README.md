...
Deployed Application (optional): [Globetrotter Deployed Site](https://dylandrozario.github.io/Globetrotter/index.html)
...
Yes the topics prepared me to complete the assignments, I used HTML and CSS. I used Flexbox and attributes for the HTML components. I felt unprepared for more of UI/UX design it was hard knowing how to start from scratch and know how to make a nice looking website.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have made my wireframes more neat I kind of rushed them. I would do these steps next: 
Add functionality for the sign-in page
Make my video play automatically 
Create a logo for the website
Add flexbox to embedded video and sign in form.


* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I think my confidence was good and I was clear and loud when speaking. I did not use many filler words. I think maybe going smoothly between slides and demoing stopping my rythmn a second, so figuring out how to do that part cleanly would be nice to do. I would like to be able to talk more about my own personal experiences I think that made their demos more memorable.
...
Emmanuel and Brandon for letting me see their websites.
The Codepath instructors for helping me for various short questions.